...
<div class="wrapper">   <!--Wrapper is used to contain and manage the layout of other elements within a page-->
    ...
    <form id="form">  <!--Used for user input-->
        ...
        <div>
            ...
            <input type="email" name="email_input" id="email_input" placeholder="Enter Email">
        </div>
        ...
        <div>
            ...
            <input type="password" name="repeat_password_input" id="repeat_password_input" placeholder="Confirm Password">
        </div>
